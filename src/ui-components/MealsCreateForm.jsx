...
export default function MealsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMeal(initialValues.meal);
    setImage_url(initialValues.image_url);
    setComment(initialValues.comment);
    setPosted_date(initialValues.posted_date);
    setPosted_by(initialValues.posted_by);
    setErrors({});
  };
  const validations = {
    meal: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Meals(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MealsCreateForm")}
      {...rest}
    >
      <TextField
        label="Meal"
